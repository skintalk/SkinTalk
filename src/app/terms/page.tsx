            ...
            <main style={{ paddingTop: '140px', paddingBottom: '100px' }}>
                <div className="container" style={{ maxWidth: '800px' }}>
                    ...
                    >
                        ...
                        <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '3rem', marginBottom: '3rem', color: '#1a1a1a' }}>Terms & Conditions</h1>
                        ...
                        <div className="terms-content" style={{ lineHeight: '1.8', color: '#444', fontSize: '1.05rem' }}>
                            ...
                            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '2.5rem', marginBottom: '2rem', color: '#1a1a1a' }}>QR Payment Policy</h1>
